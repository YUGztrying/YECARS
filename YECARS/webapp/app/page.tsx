...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white py-20 overflow-hidden rounded-3xl mt-4">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            {/* Detailing Car */}
            <Card className="border-2 border-slate-800 bg-slate-50 hover:shadow-2xl transition-all duration-300 h-full flex flex-col scale-105 z-10">
              <CardContent className="p-8 text-center flex-grow">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-3xl mb-4">
